...
const PrimaryButton = ({ children, to, onClick, className = '', variant = 'primary' }) => {
  const baseStyles = "px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 inline-block text-center w-full sm:w-auto btn-shine hover-glow btn-gradient-border focus:outline-none focus:ring-2 focus:ring-accent-primary/40 active:scale-95";
